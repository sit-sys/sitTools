...
class gTools:
    '''
    Class of general tools.
    通用工具類別
    '''
    #Space keep for class var
    
    def __init__(self):
        #Keep for instance var
        pass
    ...
    def tar_file(self, s_path, t_path):
        '''
    ...
    def f_rounding(self,f_num , d_num):
        '''
    ...
    def p_bar(self,bar_len , prog, targ):
        '''
...
class cTools:
    ...
    def r_get(self, url, header, param, times=3, sec=5):
        '''
